...
class ListShowsScreen extends Component {
  ...
  constructor(props) {
    ...
    //OlaPlay.canReactAppGoBack(true);
  }

  componentWillMount(){
    this.content = customData.livetv;
  }
        ...
        <View style={{flexDirection: 'row', flex: 1, backgroundColor: '#414a4c'}}>
          ...
          <View style={{flex: 1}}>
            <View style={{flex: 1, flexDirection: 'row', justifyContent: 'space-between'}}>
              <Text style={ styles.headingName } >{ state.params.name }</Text>
